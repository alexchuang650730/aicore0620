...
# Mock模块导入处理
try:
    from cloud_search_mcp.cloud_search_mcp import CloudSearchMcp
    MOCK_MODE = False
    print("成功导入真实模块")
...
class TestCloudSearchMcpComprehensive(IsolatedAsyncioTestCase):
    """
    CloudSearchMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = CloudSearchMcp()
