...
class TestLocalModelMcpComprehensive(IsolatedAsyncioTestCase):
    """
    LocalModelMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = LocalModelMcp()
