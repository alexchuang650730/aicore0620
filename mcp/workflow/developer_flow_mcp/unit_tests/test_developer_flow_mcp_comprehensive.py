...
# Mock模块导入处理
try:
    from developer_flow_mcp.developer_flow_mcp import DeveloperFlowMcp
    MOCK_MODE = False
    print("成功导入真实模块")
...
class TestDeveloperFlowMcpComprehensive(IsolatedAsyncioTestCase):
    """
    DeveloperFlowMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = DeveloperFlowMcp()
