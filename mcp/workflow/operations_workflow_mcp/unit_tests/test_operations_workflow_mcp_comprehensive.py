...
# Mock模块导入处理
try:
    from operations_workflow_mcp.operations_workflow_mcp import OperationsWorkflowMcp
    MOCK_MODE = False
    print("成功导入真实模块")
...
class TestOperationsWorkflowMcpComprehensive(IsolatedAsyncioTestCase):
    """
    OperationsWorkflowMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = OperationsWorkflowMcp()
