...
# Mock模块导入处理
try:
    from coding_workflow_mcp.coding_workflow_mcp import CodingWorkflowMcp
    MOCK_MODE = False
    print("成功导入真实模块")
...
class TestCodingWorkflowMcpComprehensive(IsolatedAsyncioTestCase):
    """
    CodingWorkflowMcp 完整测试套件
    """
    ...
    def setUp(self):
        ...
        # 创建测试实例
        try:
            self.test_instance = CodingWorkflowMcp()
